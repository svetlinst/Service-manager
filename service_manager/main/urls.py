...
urlpatterns = [
                  ...
                  path('customer/<int:customer_id>/customer_asset/create/', CreateCustomerAssetView.as_view(), name='create_customer_asset'),
                  path('customer/<int:customer_id>/customer_asset/<int:pk>/', EditCustomerAssetView.as_view(), name='edit_customer_asset'),
                  ...
                  path('customer/<int:customer_id>/customer_representatives/', CustomerRepresentativesListView.as_view(),
                       name='customer_representatives_list'),
                  path('customer/<int:customer_id>/customer_representative/create/', CreateCustomerRepresentativeView.as_view(),
                       name='create_customer_representative'),
                  path('customer/<int:customer_id>/customer_representative/<int:pk>/', EditCustomerRepresentativeView.as_view(),
                       name='edit_customer_representative'),
                  path('customer/<int:customer_id>/customer_representative/delete/<int:pk>/', DeleteCustomerRepresentativeView.as_view(),
