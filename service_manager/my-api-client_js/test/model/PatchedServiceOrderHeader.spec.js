...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceManagerApi.PatchedServiceOrderHeader();
  });
  ...
  describe('PatchedServiceOrderHeader', function() {
    it('should create an instance of PatchedServiceOrderHeader', function() {
      // uncomment below and update the code to test PatchedServiceOrderHeader
      //var instance = new ServiceManagerApi.PatchedServiceOrderHeader();
      //expect(instance).to.be.a(ServiceManagerApi.PatchedServiceOrderHeader);
    });
